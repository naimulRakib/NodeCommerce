...
export default function DistrictResellerLoginPage() {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {step === 1 ? "District Reseller Login" : "Select Your District"}
        </h2>
        {step === 2 && (
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          {step === 1 && (
            <form onSubmit={handleStep1Submit} className="space-y-6">
              ...
              <button
                type="button"
                onClick={() => window.location.href = "/api/dev-login?id=9cec495c-ab7a-49fa-83e8-1d12f895a143&redirectTo=/district-reseller/dashboard"}
                className="w-full mt-2 flex justify-center py-2 px-4 border border-orange-500 rounded-md shadow-sm text-sm font-medium text-orange-600 bg-white hover:bg-orange-50 focus:outline-none transition"
              >
                Dev Bypass (Login as hub@comilla.nodecom.bd)
              </button>
            </form>
          )}
