...
export default function UpazillaMonitor() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2 border-b border-gray-200/60 pb-5">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500 mt-1.5 flex items-center gap-2">
            ...
            {resellers.length} {resellers.length === 1 ? "reseller" : "resellers"} registered
          </p>
        </div>
      </div>
