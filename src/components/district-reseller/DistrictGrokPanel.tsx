...
export default function DistrictGrokPanel() {
  const [messages, setMessages] = useState<{ role: "assistant" | "user"; content: string; metrics?: any }[]>([
    {
      role: "assistant",
      content: "হ্যালো! আমি Grok AI ডিস্ট্রিক্ট অ্যানালিস্ট। আপনার ডিস্ট্রিক্ট হাবের বর্তমান স্টক এবং ন্যাশনাল ডিমান্ড বিশ্লেষণ করে আমি আপনাকে এআই-ভিত্তিক স্টক ম্যানেজমেন্ট ও রিকোয়েস্টের পরামর্শ দিতে পারি।",
    },
  ]);
  ...
  const fetchPrediction = async () => {
    setLoading(true);
    setMessages((prev) => [...prev, { role: "user", content: "কুমিল্লা সদর ডিস্ট্রিক্ট হাবের স্টক ও ন্যাশনাল ডিমান্ড বিশ্লেষণ করে একটি রিপোর্ট দিন।" }]);

    try {
      const res = await fetch("/api/district-reseller/ai-predict", { method: "POST" });
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[500px] mt-6">
      <div className="p-4 border-b border-gray-100 flex items-center gap-3 bg-slate-900 rounded-t-2xl text-white">
        <span className="text-2xl">🤖</span>
        <div>
          <h2 className="font-bold">Grok AI ডিস্ট্রিক্ট অ্যানালিস্ট</h2>
      ...
      <div className="p-4 border-t border-gray-100 bg-white rounded-b-2xl">
        ...
        >
          ...
          <span>ডিস্ট্রিক্ট অ্যানালাইসিস জেনারেট করুন</span>
        </button>
      </div>
    </div>
  );
