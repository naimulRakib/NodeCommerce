                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {editingId === item.id ? (
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <button onClick={() => saveEdit(item.id)} className="text-green-600 hover:text-green-800 p-1 bg-green-50 rounded" title="Save">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                            </button>
                            <button onClick={cancelEditing} className="text-gray-500 hover:text-gray-700 p-1 bg-gray-100 rounded" title="Cancel">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {item.quantity === 0 && (
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-red-100 text-red-800">Empty</span>
                            )}
                            {item.quantity > 0 && item.quantity <= 10 && (
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-orange-100 text-orange-800">Low</span>
                            )}
                          </div>
                        )}
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        {editingId !== item.id && (
                          <div className="flex justify-end gap-3">
                            <button onClick={() => startEditing(item.id, item.quantity)} className="text-indigo-600 hover:text-indigo-900" title="Edit Quantity">
